...
var svg = d3
	...
	.call(zoom);
const worldMap = 'https://raw.githubusercontent.com/andybarefoot/andybarefoot-www/master/maps/mapdata/custom50.json';
const argMap = 'mapa-argentina5.json';
const argMap2 = 'https://raw.githubusercontent.com/Pablets/argentina-maps/main/public/map.json';

// get map data
d3.json(argMap2, function (json) {
	//Bind data and create one path per GeoJSON feature
	countriesGroup = svg.append('g').attr('id', 'map');
	// add a background rectangle
	countriesGroup.append('rect').attr('x', 0).attr('y', 0).attr('width', w).attr('height', h);

	// draw a path for each feature/country
	countries = countriesGroup
		.selectAll('path')
		// .data(json.arcs)
		.data(topojson.feature(json, json.objects.collection).features)
		.enter()
		.append('path')
		.attr('d', path)
